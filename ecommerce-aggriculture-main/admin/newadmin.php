...
if (isset($_POST['signup'])) {
	...
	try {
		...
		$check = 0;
		$e_check = mysqli_query($mysqlCon, "SELECT email FROM `admin` WHERE email='$u_email'");
			...
			if ($check == 0) {
				if ($email_check == 0) {
					if (strlen($_POST['password']) > 4) {
						...
						$result = mysqli_query($mysqlCon, "INSERT INTO admin (firstName,lastName,email,mobile,address,password,type,confirmCode) VALUES ('$_POST[first_name]','$_POST[last_name]','$_POST[email]','$_POST[mobile]','$_POST[signupaddress]','$_POST[password]','$_POST[admintype]','$confirmCode')");
	...
	<div class="categolis">
		<table>
			<tr>
				...
				<th><a href="newadmin.php" style="text-decoration: none;color: #ddd;padding: 4px 12px;background-color: #87a64a;border-radius: 12px;">New Admin</a></th>
	...
	if (isset($success_message)) {
		...
		echo '
										...
										<div>
											<form action="" method="POST" class="registration">
												<div class="signup_form">
													<div>
														<td >
															<input autocomplete="off" name="first_name" id="first_name" placeholder="First Name" required="required" class="first_name signupbox" type="text" size="30" value="" >
														</td>
													</div>
													<div>
														<td >
															<input autocomplete="off" name="last_name" id="last_name" placeholder="Last Name" required="required" class="last_name signupbox" type="text" size="30" value="" >
														</td>
													</div>
													<div>
														<td>
			...
			>										</div>
													<div>
														<td>
															<input autocomplete="off" name="mobile" placeholder="Enter Your Mobile" required="required" class="email signupbox" type="text" size="30" value="">
														</td>
													</div>
													<div>
														<td>
															<input autocomplete="off" name="signupaddress" placeholder="Write Your Full Address" required="required" class="email signupbox" type="text" size="30" value="">
														</td>
													</div>
													<div>
														<td>
															<input autocomplete="off" name="password" id="password-1" required="required"  placeholder="Enter New Password" class="password signupbox " type="password" size="30" value="">
														</td>
													</div>
													<div>
														<td>
															<select hidden name="admintype" required="required" style=" font-size: 20px;
													...
													<div>
														<input autocomplete="off" name="signup" class="uisignupbutton signupbutton" type="submit" value="Add Admin!">
													</div>
