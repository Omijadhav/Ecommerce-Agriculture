...
<body style="min-width: 980px; background: linear-gradient(rgba(0, 0, 0, .3), rgba(0, 0, 0, .3)), url(../image/homebackgrndimg4.png);">
	...
	<div class="categolis">
		<table>
			<tr>
				<th>
					<a href="index.php" style="text-decoration: none;color: #fff;padding: 4px 12px;background-color: #87a64a;border-radius: 12px;">Home</a>
				</th>
